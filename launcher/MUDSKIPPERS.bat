@echo off
REM ====================================================================
REM  MUDSKIPPERS - local storyteller launcher
REM
REM  Self-contained: put this file anywhere and double-click it.
REM  The PowerShell it runs is written in plain sight further down, so
REM  you can read exactly what it does before trusting it.
REM ====================================================================
powershell -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "& { $m = [char]35 + 'PSSTART' + [char]35; $t = (Get-Content -LiteralPath '%~f0' -Raw) -split $m, 2; Invoke-Expression $t[1] }"
exit /b
#PSSTART#
# =====================================================================
